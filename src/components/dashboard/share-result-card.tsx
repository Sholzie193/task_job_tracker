  ...
  return (
    <section className="space-y-5">
      <div className="flex items-center justify-between">
        ...
        <div className="hidden items-center gap-2 rounded-full border border-white/10 bg-white/6 px-4 py-2 text-sm text-slate-300 md:flex">
          <Share2 className="h-4 w-4" />
          Export image later
        </div>
      </div>
      <Panel className="relative overflow-hidden bg-linear-to-br from-slate-950/80 via-slate-950/55 to-cyan-400/10">
        ...
        <div className="space-y-8">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-3xl border border-cyan-300/10 bg-cyan-300/7 p-5">
              <div className="flex items-center gap-2 text-xs uppercase tracking-[0.22em] text-cyan-100">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {run.highestExposureRoles.map((role) => (
                  <span
                    className="rounded-full border border-white/10 bg-slate-950/55 px-3 py-2 text-sm text-white"
                    key={role.roleId}
                  >
